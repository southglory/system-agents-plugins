...
- **[unity-cli](https://github.com/youngwoocho02/unity-cli)** (MIT) が `PATH` にある、v0.3+。Windows インストール: `irm https://raw.githubusercontent.com/youngwoocho02/unity-cli/master/install.ps1 | iex`
